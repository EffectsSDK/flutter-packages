...
class CameraPlugin : public flutter::Plugin,
 ...
 private:
  ...
  void SetBlurMethodHandler(const EncodableMap& args,
                            std::unique_ptr<MethodResult<>> result);
  
  void ClearBlurMethodHandler(const EncodableMap& args,
                              std::unique_ptr<MethodResult<>> result);
  
  // void SetSegmentationPresetMethodHandler(const EncodableMap& args,
  //                                         std::unique_ptr<MethodResult<>> result);
  
  void SetBeautificationLevelMethodHandler(const EncodableMap& args,
                                           std::unique_ptr<MethodResult<>> result);
  
  void ClearBeautificationMethodHandler(const EncodableMap& args,
                                        std::unique_ptr<MethodResult<>> result);
  
  void SetBackgroundImageMethodHandler(const EncodableMap& args,
                                       std::unique_ptr<MethodResult<>> result);
  
  void SetBackgroundColorMethodHandler(const EncodableMap& args,
                                       std::unique_ptr<MethodResult<>> result);
  
  void ClearBackgroundMethodHandler(const EncodableMap& args,
                                    std::unique_ptr<MethodResult<>> result);
