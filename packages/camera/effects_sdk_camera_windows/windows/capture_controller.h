...
class CaptureController {
 public:
  ...
  // Effects SDK
  virtual void SetBlur(float blurPower) = 0;
  virtual void ClearBlur() = 0;
  // virtual void SetSegmentationPreset(std::string& preset) = 0;
  virtual void SetBeautificationLevel(float level) = 0;
  virtual void ClearBeautification() = 0;
  virtual void SetBackgroundImage(const std::string& url) = 0;
...
class CaptureControllerImpl : public CaptureController,
 ...
 public:
  ...
  // EffectsSDK
  void SetBlur(float blurPower) override;
  void ClearBlur() override;
  // void SetSegmentationPreset(std::string& preset) override;
  void SetBeautificationLevel(float level) override;
  void ClearBeautification() override;
  void SetBackgroundImage(const std::string& url) override;
