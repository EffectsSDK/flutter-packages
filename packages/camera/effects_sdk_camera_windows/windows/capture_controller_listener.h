...
class CaptureControllerListener {
 public:
  ...
  virtual void OnSetBlur() = 0;

  virtual void OnClearBlur() = 0;

  virtual void OnSetBeautification() = 0;

  virtual void OnClearBeautification() = 0;
  
  virtual void OnSetBackgroundImage() = 0;

  virtual void OnSetBackgroundColor() = 0;
  ...
  virtual void OnGetResolution(int width, int height) = 0;
};
