...
class EffectsSDKCameraWindows extends CameraEffectsSDKPlatform {
  /// Registers the Windows implementation of CameraEffectsSDKPlatform.
  static void registerWith() {
    CameraEffectsSDKPlatform.instance = EffectsSDKCameraWindows();
  }
  ...
  Future<int> createCamera(
    ...
    try {
      ...
      final Map<String, dynamic>? reply = await pluginChannel.invokeMapMethod<String, dynamic>('create', <String, dynamic>{
  ...
  Future<void> initializeCamera(
    ...
    _cameraChannels.putIfAbsent(requestedCameraId, () {
      final MethodChannel channel = MethodChannel('plugins.flutter.io/camera_windows/camera$requestedCameraId');
  ...
  @override
  Future<void> prepareForVideoRecording() => pluginChannel.invokeMethod<void>('prepareForVideoRecording');
