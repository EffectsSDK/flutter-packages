...
class CameraImpl : public Camera {
 public:
  ...
  void OnSetBlur() override;
  void OnClearBlur() override;
  void OnSetBeautification() override;
  void OnClearBeautification() override;
  void OnSetBackgroundImage() override;
  ...
  void OnGetResolution(int width, int height) override;
